...
public class RateResourceIT {
    ...
    private static final Float DEFAULT_RATE = Float.intBitsToFloat(1);
    private static final Float UPDATED_RATE = Float.intBitsToFloat(2);
    ...
    public void getRate() throws Exception {
        ...
        restRateMockMvc.perform(get("/api/rates/{id}", rate.getId()))
            ...
            .andExpect(jsonPath("$.idname").value(DEFAULT_NAME.toString()))
