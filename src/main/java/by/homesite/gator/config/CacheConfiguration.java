...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, by.homesite.gator.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, by.homesite.gator.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, by.homesite.gator.domain.User.class.getName());
            createCache(cm, by.homesite.gator.domain.Authority.class.getName());
            ...
            createCache(cm, by.homesite.gator.domain.UserSites.class.getName());
