...
class CategoryResourceIT {
     ...
     *
     * @see by.homesite.gator.repository.search.CategorySearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public static Category createEntity(EntityManager em) {
        Category category = new Category().name(DEFAULT_NAME).link(DEFAULT_LINK).active(DEFAULT_ACTIVE);
        return category;
    }
    ...
    public static Category createUpdatedEntity(EntityManager em) {
        Category category = new Category().name(UPDATED_NAME).link(UPDATED_LINK).active(UPDATED_ACTIVE);
        return category;
    }
    ...
    void fullUpdateCategoryWithPatch() throws Exception {
        ...
        partialUpdatedCategory.name(UPDATED_NAME).link(UPDATED_LINK).active(UPDATED_ACTIVE);
